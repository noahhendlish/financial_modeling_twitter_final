---
title: "Financial Modeling Final Project"
author: "Noah Hendlish, Aaron Rabinovich, Charlie Hoffman, Matt Reisin"
date: "11/29/2018"
...
#SETUP ENVIROMENT
```{r enviromeent setup, echo=FALSE}
...
##SAMPLING, BASIC DATA ANALYSIS
```{r sampling}
#BASIC ENVIROMENT SET UP (READ IN CSVS AND SET UP DATA FRAMES)
...
m2_1 <- rpart(malicious~.,data=train,parms=list(prior=c(.83,.17)),cp=.0002) #- build model using 60%-40% priors
...
test2$m3_score <- predict(m3, test2, type="response")
...
part_quanti<-cutreevar(tweets_quanti_cluster_tree,4)
print(part_quanti)
summary(part_quanti)
